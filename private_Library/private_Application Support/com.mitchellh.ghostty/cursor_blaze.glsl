...
// const vec4 TRAIL_COLOR = vec4(0.96, 0.663, 0.498, 1.0); // Macchiato Peach
const vec4 TRAIL_COLOR_ACCENT = vec4(0.933, 0.831, 0.623, 1.0); // Macchiato Yellow 
const vec4 TRAIL_COLOR = TRAIL_COLOR_ACCENT;
